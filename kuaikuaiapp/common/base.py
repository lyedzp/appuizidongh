...
class Base():
    ...
    def getX_Y(self,widthx,heightx):
        print(self.a)     #vivo分辨率{'width': 1080, 'height': 2141}   xiaomi9分辨率'width': 1080, 'height': 2135
        width_x = self.a['width']
        height_y = self.a['height']
        xd_x = (1000/widthx)*width_x
        xd_y = (2090/heightx)*height_y
        return xd_x,xd_y
